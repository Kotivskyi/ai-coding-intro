...
4. **Data Layer**:
   - **MongoDB**: Primary data store for users, messages, and conversations.
   - **Redis**: Caching layer for frequently accessed data and session management.
   - **S3**: Storage for uploaded files and images.
    ...
    "attachments": [
      {
        ...
        "fileSize": 2500000,
        "fileUrl": "https://s3.example.com/files/document.pdf"
      }
    ],
...
│                                                                 │
│  ┌─────────────┐   ┌─────────────┐   ┌─────────────────────┐   │
│  │  Ingress    │   │  Frontend   │   │  Backend Services   │   │
│  │  Controller │──▶│  Pods       │   │                     │   │
│  └─────────────┘   └──────┬──────┘   │  ┌───────────────┐  │   │
│                           │          │  │  API Gateway  │  │   │
│                           │          │  └───────┬───────┘  │   │
